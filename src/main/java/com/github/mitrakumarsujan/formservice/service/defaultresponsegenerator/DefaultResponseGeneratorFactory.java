 ...
 */
@Service
public class DefaultResponseGeneratorFactory {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultResponseGeneratorFactory.class);

	public DefaultResponseGeneratorFactory() {
